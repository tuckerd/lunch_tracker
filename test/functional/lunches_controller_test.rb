...
class LunchesControllerTest < ActionController::TestCase
  ...
  test "should create lunch" do
    assert_difference('Lunch.count') do
      post :create, lunch: { date: @lunch.date, food: @lunch.food, nutritional_quality: @lunch.nutritional_quality }
    end
  ...
  test "should update lunch" do
    put :update, id: @lunch, lunch: { date: @lunch.date, food: @lunch.food, nutritional_quality: @lunch.nutritional_quality }
    assert_redirected_to lunch_path(assigns(:lunch))
  end
